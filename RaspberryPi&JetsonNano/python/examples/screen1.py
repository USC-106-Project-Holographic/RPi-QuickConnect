...
try:
    ...
    font18 = ImageFont.truetype(os.path.join(picdir, 'FiraCode-SemiBold.ttf'), 16)
    ...
    drawblack.text((10, 0), 'Host: ' + socket.gethostname(), font = font18, fill = 0)
    drawblack.text((10, 20), 'IPv4: ' + socket.gethostbyname(socket.gethostname()), font = font18, fill = 0)
