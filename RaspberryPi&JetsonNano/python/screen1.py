...
try:
    ...
    drawblack.text((10, 0), 'Host: ' + socket.gethostname(), font = font24, fill = 0)
    drawblack.text((10, 20), 'IP Address: ' + socket.gethostbyname(socket.gethostname()), font = font24, fill = 0)
